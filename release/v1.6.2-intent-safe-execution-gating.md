...
4. Preserve existing analytical-intent skip behavior.

## Out of Scope

1. New explicit override command syntax (`/trade confirm ...`).
2. Changes to autonomous scan execution criteria.
3. Policy/risk threshold tuning.
