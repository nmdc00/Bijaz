...
Branch: `feat/v1.6.1-scheduled-report-jobs`

1. Add explicit scheduled report commands:
- `/schedule_report tomorrow 9:45am`
- `/schedule_report daily 09:45`
- `/schedule_report every 30m`
- `/scheduled_reports`
- `/unschedule_report <id>`
2. Persist scheduled report jobs in DB and rehydrate job handlers on gateway startup.
3. Add natural-language scheduling-intent guard so report-time requests do not fall into trade execution flow.
